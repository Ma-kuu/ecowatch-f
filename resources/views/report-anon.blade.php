...
@section('content')
  ...
  <main class="container" style="padding-top: 90px;">
    <div class="form-card">
      <h4 class="fw-bold mb-3 text-success">📋 Submit an Anonymous Environmental Concern</h4>
      <form id="reportForm" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="email" name="reporter_email" class="form-control" placeholder="your.email@example.com" id="emailInput">
          <small class="text-muted">Provide your email to receive updates on your report.</small>
        </div>
