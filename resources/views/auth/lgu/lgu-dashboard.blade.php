...
<head>
    ...
    <title>LGU Dashboard - EcoWatch</title>
...
<body>
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="fw-semibold mb-0">#ECO-2025-051</p>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="mb-0">Water Pollution</p>
                                </div>
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="col-12">
                            ...
                            <p class="mb-2">Brgy. Datu Abdul Dadia, Panabo City</p>
                            <!-- Map -->
                        ...
                        <div class="col-12">
                            ...
                            <img src="https://via.placeholder.com/400x300?text=Water+Contamination" alt="Report Evidence" class="report-image-preview shadow-sm">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <p class="text-muted">Chemical discharge from factory affecting nearby creek. Strong odor and discoloration observed.</p>
                        </div>
                ...
                <div class="modal-body">
                    <form id="markFixedForm">
                        ...
                        <div class="alert alert-info">
                            <small><i class="bi bi-info-circle"></i> You are marking report <strong>#ECO-2025-051</strong> as fixed. Please provide proof and details of actions taken.</small>
                        </div>
    ...
    <script>
        ...
        document.getElementById('viewReportModal').addEventListener('shown.bs.modal', function () {
            if (!viewMap) {
                viewMap = L.map('viewMap').setView([7.3091, 125.6838], 13);
                L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
                }).addTo(viewMap);
                
                viewMarker = L.marker([7.3091, 125.6838]).addTo(viewMap)
                    .bindPopup('<b>Water Pollution</b><br>Brgy. Datu Abdul Dadia, Panabo City')
                    .openPopup();
            }
            setTimeout(function() {
