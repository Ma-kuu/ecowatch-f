        ...
        <div class="container">
            ...
            <div class="card shadow-sm border-0 mb-4">
                        ...
                        <table class="table table-hover mb-0" id="usersTable">
                            ...
                            <tbody>
                                <tr data-role="admin" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1001</td>
                                    <td class="py-3">Juan Dela Cruz</td>
                                    <td class="py-3">juan.delacruz@ecowatch.ph</td>
                                    <td class="py-3"><span class="badge bg-danger">Admin</span></td>
                                ...
                                <tr data-role="lgu" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1002</td>
                                    <td class="py-3">Maria Santos</td>
                                    <td class="py-3">maria.santos@lgu-manila.gov.ph</td>
                                    <td class="py-3"><span class="badge bg-info text-dark">LGU</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                            <i class="bi bi-pencil"></i>
                                ...
                                <tr data-role="user" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1003</td>
                                    <td class="py-3">Pedro Reyes</td>
                                    <td class="py-3">pedro.reyes@gmail.com</td>
                                    <td class="py-3"><span class="badge bg-secondary">User</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                            <i class="bi bi-pencil"></i>
                                ...
                                <tr data-role="lgu" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1004</td>
                                    <td class="py-3">Ana Garcia</td>
                                    <td class="py-3">ana.garcia@lgu-quezon.gov.ph</td>
                                    <td class="py-3"><span class="badge bg-info text-dark">LGU</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                ...
                                <tr data-role="user" data-status="suspended">
                                    <td class="px-4 py-3 fw-semibold">#1005</td>
                                    <td class="py-3">Carlos Mendoza</td>
                                    <td class="py-3">carlos.mendoza@yahoo.com</td>
                                    <td class="py-3"><span class="badge bg-secondary">User</span></td>
                                    <td class="py-3"><span class="badge bg-warning text-dark">Suspended</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                ...
                                <tr data-role="user" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1006</td>
                                    <td class="py-3">Rosa Alvarez</td>
                                    <td class="py-3">rosa.alvarez@gmail.com</td>
                                    <td class="py-3"><span class="badge bg-secondary">User</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                ...
                                <tr data-role="admin" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1007</td>
                                    <td class="py-3">Roberto Cruz</td>
                                    <td class="py-3">roberto.cruz@ecowatch.ph</td>
                                    <td class="py-3"><span class="badge bg-danger">Admin</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                                ...
                                <tr data-role="lgu" data-status="active">
                                    <td class="px-4 py-3 fw-semibold">#1008</td>
                                    <td class="py-3">Luisa Fernandez</td>
                                    <td class="py-3">luisa.fernandez@lgu-cebu.gov.ph</td>
                                    <td class="py-3"><span class="badge bg-info text-dark">LGU</span></td>
                                    <td class="py-3"><span class="badge bg-success">Active</span></td>
                                    <td class="py-3 text-center table-actions">
                                        <button class="btn btn-sm btn-outline-primary me-1" data-bs-toggle="modal" data-bs-target="#userModal">
                ...
                <div class="card-footer bg-white border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">Showing 8 of 8 users</small>
                        <nav>
